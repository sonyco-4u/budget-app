...
# It also defines a 'has_many' association with the 'CategoryExpense' model, and a 'has_many through' association with the 'Expense' model,
# to establish a many-to-many relationship between categories and expenses.
